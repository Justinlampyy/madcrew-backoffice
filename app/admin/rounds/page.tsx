    ...
    <RequireAdmin>
      <div className="mx-auto max-w-3xl p-4">
        ...
        <div className="mt-4 rounded-2xl border p-3 flex gap-2">
          <input value={name} onChange={(e) => setName(e.target.value)} placeholder="Naam (bijv. Najaar 2025)" className="flex-1 rounded-xl border px-3 py-2" />
        ...
        <div className="mt-4 border rounded-3xl overflow-hidden">
          <table className="w-full text-sm">
            <thead className="bg-neutral-50 text-neutral-600">
              <tr><th className="text-left p-3">Naam</th><th className="text-left p-3">Status</th><th className="text-right p-3">Acties</th></tr>
            </thead>
            <tbody>
              {rounds.map((r) => (
              ...
              {rounds.length === 0 && (<tr><td colSpan={3} className="p-6 text-center text-neutral-600">Nog geen rondes.</td></tr>)}
            </tbody>
          </table>
        </div>
      </div>
